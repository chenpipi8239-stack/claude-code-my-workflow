...
2. Open the HTML in browser: `open docs/slides/LectureX.html` (macOS), `xdg-open` (Linux), or `start docs/slides/LectureX.html` (Windows)
...
2. Open the PDF to verify figures render (`open` on macOS, `xdg-open` on Linux, `start` on Windows)
